...
python ${MSCCL_TOOLS_ALGORITHMS}/binary/allreduce_binary_tree_p_gpu01_channel4.py --protocol=Simple 1 2 8 4 1 > ${MSCCL_TOOLS_XML}/allreduce_binary_tree_p_gpu01_channel4_chunk8.xml
