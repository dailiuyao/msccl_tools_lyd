...
###################### recursive_doubling ######################
# only support up to 2 channels
python3 ${MSCCL_TOOLS_ALGORITHMS}/recursive_doubling/allreduce_recursive_doubling_p.py --protocol=Simple --num_gpus=4 --num_nodes=4 --nchunks=4 --nchannel=2 --instances=1 > ${MSCCL_TOOLS_XML}/recursive_doubling/allreduce_recursive_doubling.xml