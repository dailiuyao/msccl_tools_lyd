...
python ${MSCCL_TOOLS_ALGORITHMS}/binary/allreduce_binary_tree_p_gpu01_channel_n.py --protocol=Simple 1 3 6 2 1 > ${MSCCL_TOOLS_XML}/allreduce_binary_tree_p_gpu01_3nodes_channel2_chunk6.xml
