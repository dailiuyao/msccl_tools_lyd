...
# directory="/Users/liuyaodai/github/msccl_tools_lyd/examples/scripts/polaris-test/sc24/log/paper0/buffer_size_4/tree"
...
dst_directory="/Users/liuyaodai/github/sc24-log/polaris"

for file in "$directory"/*; do
    cp "$file" "$dst_directory/$(basename "$file")"
done
...
# directory="/Users/liuyaodai/github/msccl_tools_lyd/examples/scripts/polaris-test/sc24/log/paper0/buffer_size_4/ring"

# for file in "$directory"/*; do
#     cp "$file" "${file//node32_gpu128/node64_gpu256}"
# done
