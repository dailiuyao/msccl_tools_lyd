...
# echo "NCCL TEST with MSCCL 2 channel 2gpus 2 steps"

# export MSCCL_XML_FILES=${MSCCL_TOOLS_SRC_LOCATION}/examples/xml/xml_lyd/binary_h_gpu01_reverse_p/allreduce_binary_tree_p_gpu01_1nodes_2gpus_channel2_chunk2.xml
# export NCCL_ALGO=MSCCL,TREE,RING

# export NCCL_NTHREADS=64

# $MPIEXEC_HOME/bin/mpiexec -n 2 --ppn 2 --cpu-bind core ${NCCL_TEST_MSCCL_HOME}/build/all_reduce_perf -b 1K -e 256MB -f 2 -g 1 -n 60
