...
$MPIEXEC_HOME/bin/mpiexec -n 64 --ppn 4 --cpu-bind core ${NCCL_TEST_HOME}/build/all_reduce_perf -b 1K -e 512MB -f 2 -g 1
...
export NCCL_DEBUG=TRACE
export NCCL_DEBUG_SUBSYS=INIT,ENV
export MSCCL_XML_FILES=${MSCCL_TOOLS_SRC_LOCATION}/examples/xml/xml_lyd/binary_h_gpu01_reverse_p/allreduce_binary_tree_p_gpu01_16nodes_4gpus_channel2_chunk2.xml
export NCCL_ALGO=MSCCL,TREE,RING
export NCCL_PROTO=Simple
#export NCCL_NTHREADS=256

$MPIEXEC_HOME/bin/mpiexec -n 64 --ppn 4 --cpu-bind core ${NCCL_TEST_MSCCL_HOME}/build/all_reduce_perf -b 1K -e 512MB -f 2 -g 1
...
export NCCL_DEBUG=TRACE
export NCCL_DEBUG_SUBSYS=INIT,ENV
export MSCCL_XML_FILES=${MSCCL_TOOLS_SRC_LOCATION}/examples/xml/xml_lyd/binary_h_gpu01_reverse_p/allreduce_binary_tree_p_gpu01_16nodes_4gpus_channel4_chunk2.xml
export NCCL_ALGO=MSCCL,TREE,RING
export NCCL_PROTO=Simple
#export NCCL_NTHREADS=256
...
export NCCL_DEBUG=TRACE
export NCCL_DEBUG_SUBSYS=INIT,ENV
export MSCCL_XML_FILES=${MSCCL_TOOLS_SRC_LOCATION}/examples/xml/xml_lyd/binary_h_gpu01_reverse_p/allreduce_binary_tree_p_gpu01_16nodes_4gpus_channel8_chunk2.xml
export NCCL_ALGO=MSCCL,TREE,RING
export NCCL_PROTO=Simple
#export NCCL_NTHREADS=256
