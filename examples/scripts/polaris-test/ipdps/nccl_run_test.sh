...
#PBS -A SR_APPFL 
#PBS -k doe
#PBS -N ccl-4nodes-chunk
#PBS -o log/ccl-4nodes-chunk.out
#PBS -e log/ccl-4nodes-chunk.error
...
$MPIEXEC_HOME/bin/mpiexec -n 16 --ppn 4 --cpu-bind core ${NCCL_TEST_HOME}/build/all_reduce_perf -b 64K -e 256MB -f 2 -g 1 -n 60
