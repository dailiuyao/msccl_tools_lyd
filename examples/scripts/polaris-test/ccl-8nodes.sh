...
# export NCCL_DEBUG=TRACE
# export NCCL_DEBUG_SUBSYS=INIT,ENV
# export MSCCL_XML_FILES=${MSCCL_TOOLS_SRC_LOCATION}/examples/xml/allreduce_binary_tree_p_gpu01_8nodes_channel2_chunk64.xml
...
# export NCCL_DEBUG=TRACE
# export NCCL_DEBUG_SUBSYS=INIT,ENV
# export MSCCL_XML_FILES=${MSCCL_TOOLS_SRC_LOCATION}/examples/xml/allreduce_binary_tree_p_gpu01_8nodes_channel4_reverse_chunk128.xml
# export NCCL_ALGO=MSCCL,TREE,RING
# export NCCL_PROTO=Simple
# export NCCL_NTHREADS=512
# 
