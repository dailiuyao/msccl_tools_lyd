...
echo "##################################### NCCL Tree 2 nodes #####################################" >> output.log 2>&1
...
echo "##################################### NCCL Tree 4 nodes #####################################" >> output.log 2>&1
...
echo "##################################### MSCCL Tree 2 nodes #####################################" >> output.log 2>&1
...
echo "##################################### MSCCL Tree 4 nodes #####################################" >> output.log 2>&1
...
export MSCCL_XML_FILES=/home1/09168/ldai1/ccl-build/msccl_tools_lyd/examples/xml/xml_lyd/allredcue_basic_binary_tree_32gpus.xml
