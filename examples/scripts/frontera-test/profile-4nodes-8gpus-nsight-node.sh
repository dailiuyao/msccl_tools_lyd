...
export MSCCL_XML_FILES=/home1/09168/ldai1/ccl-build/msccl_tools_lyd/examples/xml/xml_lyd/binary_h_gpu01_reverse_p/allreduce_binary_tree_p_gpu01_4nodes_16gpus_channel2_reverse_chunk2.xml
...
bash -c 'nsys profile --force-overwrite true -o msccl-output/nsys_test_msccl_profile_rank${OMPI_COMM_WORLD_RANK:-$PMI_RANK} --stats=true $NCCLTESTS_MSCCL_SRC_LOCATION/build/all_reduce_perf -b 16M -e 16M -f 2 -g 1 -n 60' \
&>> output.log
