...
#SBATCH -o ../log/paper0/ccl-run-8nodes-32gpus-ring.o%j       # Name of stdout output file
#SBATCH -e ../log/paper0/ccl-run-8nodes-32gpus-ring.e%j       # Name of stderr error file
...
##SBATCH -A ccl-run-8nodes-32gpus-ring        # Project/Allocation name (req'd if you have more than 1)
