...
export MSCCL_XML_FILES=/home1/09168/ldai1/ccl-build/msccl_tools_lyd/examples/xml/xml_lyd/binary_tree/allgather_binary_tree.xml
...
ibrun -n 16 --ntasks-per-node=4 $NCCLTESTS_MSCCL_SRC_LOCATION/build/all_gather_perf -b 1M -e 256M -f 2 -g 1 -n 60
