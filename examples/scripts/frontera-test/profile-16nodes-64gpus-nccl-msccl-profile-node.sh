...
#SBATCH -o ./log/ccl-run-16nodes-64gpus-nccl.o%j       # Name of stdout output file
#SBATCH -e ./log/ccl-run-16nodes-64gpus-nccl.e%j       # Name of stderr error file
...
# $MPI_HOME/bin/mpirun -np 64 --hostfile /home1/09168/ldai1/ccl-build/msccl_tools_lyd/examples/scripts/frontera-test/myhostfile_16nodes -ppn 4 $NCCLTESTS_SRC_LOCATION/build/all_reduce_perf -b 16MB -e 16MB -f 2 -g 1 -n 100 >> output.log 2>&1
...
$MPI_HOME/bin/mpirun -np 64 --hostfile /home1/09168/ldai1/ccl-build/msccl_tools_lyd/examples/scripts/frontera-test/myhostfile_16nodes -ppn 4 $NCCLTESTS_MSCCL_SRC_LOCATION/build/all_reduce_perf -b 16MB -e 16MB -f 2 -g 1 -n 100 >> output.log 2>&1