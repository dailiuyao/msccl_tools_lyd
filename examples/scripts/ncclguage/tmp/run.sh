...
$MPI_HOME/bin/mpirun -np 4 -ppn 2 -hosts node03:2,node04:2 /home/liuyao/scratch/deps/msccl_tools_lyd/examples/scripts/ncclguage/tmp/ncclp2p.exe > output.log 2>&1
